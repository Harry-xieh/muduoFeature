...
public:
    ...
    static ItemPtr makeItem(muduo::StringPiece keyArg, uint32_t flagsArg, int exptimeArg, int valuelen, uint64_t casArg)
    {
    ...
    Item(muduo::StringPiece keyArg, uint32_t flagsArg, int exptimeArg, int valuelen, uint64_t casArg);
